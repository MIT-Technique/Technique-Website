        ...
        <div className="relative inline-block">
          ...
          {!disabled && (
            <button
              ...
              disabled={uploading}
              className="absolute -top-2 -right-2 w-6 h-6 bg-red-600 text-white rounded-full flex items-center justify-center text-xs hover:bg-red-700 disabled:cursor-wait"
