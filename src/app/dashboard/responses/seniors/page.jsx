  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-4">
        <h2 className="text-lg font-medium">{"Senior Bios"}</h2>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-bg-secondary">
              ...
              <th className="text-left p-2 font-medium">{"Major"}</th>
              <th className="text-left p-2 font-medium">{"Minor"}</th>
              <th className="text-left p-2 font-medium">{"2nd Major"}</th>
              <th className="text-left p-2 font-medium">{"Quote"}</th>
              <th className="text-left p-2 font-medium">{"Achievements"}</th>
              <th className="text-left p-2 pr-3 font-medium">{"Photo Pref."}</th>
            </tr>
          </thead>
          <tbody>
            {paginated.map((bio) => {
            ...
            {paginated.length === 0 && (
              <tr><td colSpan={8} className="p-3 text-center text-text-secondary">{"No data found"}</td></tr>
            )}
          </tbody>
        </table>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        >
          {exporting ? "Exporting..." : "Export Senior Bios CSV"}
        </button>
        <button
