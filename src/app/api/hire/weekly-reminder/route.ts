      ...
      <div style="font-family: Raleway, Arial, sans-serif; max-width: 700px; margin: 0 auto; background: #F9F5F5; color: #1A1A1A; font-weight: 300;">
        ...
        <div style="padding: 28px 32px 32px;">
          ...
          <div style="text-align: center; margin: 28px 0;">
            <a href="https://technique.mit.edu/en/hire" style="display: inline-block; background: #750014; color: #ffffff; text-decoration: none; padding: 14px 40px; border-radius: 24px; font-weight: 600; font-size: 14px; letter-spacing: 0.5px;">View &amp; Assign Photographers</a>
          </div>
