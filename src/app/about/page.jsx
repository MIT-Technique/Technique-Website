          ...
          <div className="container-content">
            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="card">
                ...
                <p>
                  &quot;But why?&quot; you ask. We don&apos;t know either, but
                  H.R.H. Grogo has been there since the beginning, inscribed in
                  the back of the very first <em>Technique</em>, and has been
              ...
              <div className="card">
                ...
                <h3>Weekly</h3>
                <p>
                  We hold regular meetings at 12pm on Saturday in 4-253. Anyone
                  is welcome to attend. We have photographic equipment for
                  borrowing and often teach various photography and design
                  related seminars at this time.
                </p>
                <p>
                  During book season, fall term through early spring term, we
                  hold regular meetings during the week where the various
                  editors of each <em>Technique</em> section come in and do
                  work. This is the best time to get involved with the process
                  of crafting a yearbook.
                </p>
                <p>
                  We also enjoy going on photowalks and different photographic
