        ...
        <main className="w-full px-12 md:px-60 pb-6">
          ...
          <div className="flex flex-col mt-8 space-y-5">
            <p className="text-center">
              ...
              showcase MIT in its truest form, candidly, at its best and at its
              worst. We know how tough the Institute can be, and we know how
              rewarding it is to get to the other side.
            </p>
            <p className="text-center">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                the back of the very first <i>Technique </i>, and has been there
                ever since. We&apos;re not quite sure how or when he became a
                gorilla.
              </p>
            </div>
          </div>
